...
!  */
FUNCTION: c-string yaml_get_version_string ( ) ;
...
!  */
FUNCTION: void yaml_get_version ( int *major, int *minor, int *patch ) ;
...
FUNCTION: bool yaml_stream_start_event_initialize (
    yaml_event_t *event,
...
FUNCTION: bool yaml_stream_end_event_initialize ( yaml_event_t *event ) ;
