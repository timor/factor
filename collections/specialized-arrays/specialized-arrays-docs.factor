...
{ \ SPECIALIZED-ARRAY: \ SPECIALIZED-ARRAYS: } related-words
...
"The " { $link \ SPECIALIZED-ARRAY: } " and " { $link \ SPECIALIZED-ARRAYS: } " parsing words generate specialized array types if they haven't been generated already and add the following words to the vocabulary search path, where " { $snippet "T" } " is the C type in question:"
{ $table
...
"Behind the scenes, these words are placed in a vocabulary named " { $snippet "specialized-arrays.instances.T" } ", however this vocabulary should not be placed in a " { $link \ USING: } " form directly. Instead, always use " { $link \ SPECIALIZED-ARRAY: } " or " { $link \ SPECIALIZED-ARRAYS: } ". This ensures that the vocabulary can get generated the first time it is needed."
$nl
