...
! Quote one iteration
! I think this basically pulls one iteration into the unit effect...

! CHR: resolve-recursive-unit-right @ { MakeUnit ?rho ?sig } { ComposeType ?d ?sig ?tau } // { Recursion ?l ?rho ?e } --
! [ ?e valid-effect-type? ]
! [ ?d valid-effect-type? ]
! [ ?sig term-var? ]
! [ ?tau term-var? ]
