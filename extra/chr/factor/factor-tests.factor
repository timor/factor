USING: chr.factor.compiler chr.factor.stack kernel terms tools.test ;
IN: chr.factor.tests


TERM-VARS: s1 st1 sf1 rho a v sig x y s u ;
! : wake-problem ( -- x )
!     {
!         P{ Branch s u st1 sf1 }
...
[ [ [ swap ] [ 1 2 ] if ] chrat-infer ] [ imbalanced-branch-stacks? ] must-fail-with
